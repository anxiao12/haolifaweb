    ...
    <div class="page-cashAccounting-list">
        ...
        <div class="flex-item scroll-y">
            <data-list
                ...
                :page-size="15"
                :param="filter"
                url="/haolifa/finance/bankbill/getBankBillList"
                method="post"
            >
                <tr slot="header">
...
export default {
    ...
    methods: {
        ...
        getSubjectList() {
            this.subjectList = [];
            this.$http
                .post(`/haolifa/finance/costbudget/subjects/getCurDeptIdSubjectsTypeList`, { deptId: this.form.deptId })
                .then((res) => {
                    res.forEach((item) => {
                        this.subjectList.push({
                            text: item.subjectsTypeName,
        ...
        subChange(scope) {
            ...
            if (this.subjectType) {
                this.$http
                    .get(
                        `/haolifa/finance/costbudget/subjects/getCurDeptSubjectsBudgetList/${this.subjectType}/${this.form.deptId}`
                        // `/haolifa/finance/costbudget/subjects/getCurUserSubjectsBudgetList/${this.subjectType}`
                    )
                    .then((res) => {
                        res.forEach((item) => {
        ...
        getProjectList() {
            ...
            this.getSubjectList();
            this.$http
                .post(`/haolifa/finance/projectbudget/getCurProjectBudgetList`, {
        ...
        remove(item) {
            this.$confirm({
                ...
                yes: () => {
                    this.$http
                        .get(`/haolifa/finance/bankbill/delete/${item.id}`)
                        .then((res) => {
                            this.$toast("删除成功");
                            this.$refs.list.update(true);
                        })
        ...
        save() {
            ...
            this.$confirm({
                ...
                btns: ["取消", "确认"],
                yes: () => {
                    let url = this.form.id ? "/haolifa/finance/bankbill/updateBankBill" : "/haolifa/finance/bankbill/save";
                    this.$http
                        .post(url, this.form)
                        .then((res) => {
                            this.close();
