    ...
    <div class="page-cashAccounting-list">
        ...
        <layer v-if="layer" :title="form.id ?'编辑':'新增'" width="50%">
            <div class="layer-text" style="padding-bottom: 50px;">
                <div class="flex">
                    <input-box v-model="form.bh" class="flex-item mr-20" label="设备编号"></input-box>
                    <input-box v-model="form.name" class="flex-item mr-20" label="设备名称"></input-box>
                ...
                <div class="flex">
                    <select-box
                        ...
                        label="类别名称"
                    ></select-box>
                    <input-box v-model="form.num" class="flex-item mr-20" label="设备数量"></input-box>
                    <input-box v-model="form.price" class="flex-item mr-20" label="采购金额"></input-box>
                </div>
                <div class="flex">
                    <input-box v-model="form.netWorth" class="flex-item mr-20" label="净值"></input-box>
                    <input-box v-model="form.outputRate" class="flex-item mr-20" label="净产值率"></input-box>
