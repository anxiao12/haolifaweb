<template>
    <div class="purchaseadd flex-col">
        ...
        <div class="flex-item scroll-y">
            <data-list ref="list" method="get" :page-size="15" :param="filter" url="/haolifa/purchase-order/list/0">
                <tr slot="header">
                ...
                <template slot="item" slot-scope="{ item, index }">
                    ...
                    <td>
                        <a href="javascript:;" class="blue" @click="numClick(item.purchaseOrderNo)">{{item.qualifiedNumber}}</a>
                    </td>
...
export default {
    ...
    methods: {
            ...
            this.$http
                ...
                .then(res => {
                    ...
                    this.$confirm({
                        ...
                        no: () => {
                            this.$http
                                .get(`/haolifa/material-inspect/delete/${res}`)
                                .then(res => {});
                        }
                    });
                });
        ...
        numClick(purchaseNo) {
            ...
            this.$http
                .get(
                    `/haolifa/material-inspect/purchase-all-qty?purchaseNo=${purchaseNo}`
                )
                .then(res => {
                    this.numList = res;
                })
