    ...
    <div class="page-material-list">
        ...
        <div class="flex-v-center tool-bar">
            <div class="flex-v-center search-bar" style="margin-right: 20px;">
                ...
                <input type="text" class="flex-item" v-model="filter.graphNo" @change="$refs.list.update(true);getMoney()" placeholder="图号" style="width: 200px;">
                ...
                <input type="text" class="flex-item" v-model="filter.specifications" @change="$refs.list.update(true);getMoney()" placeholder="规格" style="width: 100px;">
