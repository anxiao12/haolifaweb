<template>
    <div class="page-invoice-list">
        ...
        <div class="flex-item scroll-y">
            <data-list ref="list" :page-size="15" :param="filter" url="/haolifa/pay-user/getScoreUserList" method="post">
                <tr slot="header">
                ...
                <template slot="item" slot-scope="{ item, index }">
                    ...
                    <td class="t-right">
                        <a href="javascript:;" class="blue" @click="edit(item)">打分</a>
                        <!-- <a href="javascript:;" class="red" @click="remove(item)">删除</a> -->
                    </td>
                </template>
            </data-list>
        </div>
        <layer v-if="layer" title="打分 " width="70%">
    ...
    methods: {
        ...
        save() {
            ...
            let url = this.form.id
                ? "/haolifa/pay-assessment-score/edit"
                : "/haolifa/pay-assessment-score/save";
            this.$http
                .post(url, this.form)
                .then(res => {
                    this.layer = false;
