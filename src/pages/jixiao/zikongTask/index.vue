    ...
    <div class="page-material-list">
        ...
        <div class="flex-item scroll-y">
            <data-list
                ...
                :page-size="15"
                :param="filter"
                url="/haolifa/auto-control-entrust/page"
                method="post"
            >
                <tr slot="header">
...
export default {
    ...
    methods: {
        ...
        updateTask(orderNo) {
            ...
            this.$http
                .get(`/haolifa/pay-working-procedure/assignTask?type=4&orderNo=` + orderNo)
                .then((res) => {
                    this.loading = false;
                    if (!res) {
                        return;
        ...
        saveSelect() {
            ...
            this.$http
                .post(`/haolifa/pay-working-procedure/saveTask`, this.param)
                .then((res) => {
        ...
        sprayInfo(item) {
            ...
            // 质检记录列表；
            this.$http
                .get(`/haolifa/auto-control-entrust/inspect/list/${item.entrustNo}`)
                .then((res) => {
