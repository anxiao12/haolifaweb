export default [
  ...
  },
  {
    ...
    component: () =>
      import(/* webpackChunkName: "supplieradd" */ './addList.vue'),
    meta: {
      level: 2,
      title: '新增供应商',
      open: false,
  ...
  },
  {
    ...
    component: () =>
      import(/* webpackChunkName: "supplieradd" */ './accessoryInfo.vue'),
    meta: {
      level: 2,
      title: '供应商审批附件',
      open: false,
  ...
  },
  {
    ...
    component: () =>
      import(/* webpackChunkName: "supplieradd" */ './approveProgress.vue'),
    meta: {
      level: 2,
      title: '供应商审批进度',
      open: false,
