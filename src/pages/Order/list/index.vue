            ...
            <div class="layer-text" style="padding-bottom: 50px;">
                <div class="form-content metalwork-info">
                    <table class="f-14 order-info">
                        ...
                        <tr>
                            <td colspan="17" class="b">订单编号 : {{ info.orderNo }}</td>
                        </tr>
                        <tr>
                            <!-- <td colspan="14" class="b">成品合同订单号 : {{info.orderContractNo}}</td> -->
                            <td colspan="17" class="b">发货日期 : {{ info.deliveryDate }}</td>
                        </tr>
                        <tr>
                            <td colspan="17" class="b">订单状态 : {{ orderStatusList[info.orderStatus].text }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="17" class="b" v-if="fileDetailList.length">订单附件:</td>
                            <td colspan="17" class="b" v-else>订单附件:无</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="9" class="b">装配小组: {{ info.assemblyGroup }}</td>
                        </tr>
                        <tr>
                            <td colspan="8" class="b">采购反馈时间: {{ info.purchaseFeedbackTime }}</td>
                            <td colspan="9" class="b">生产反馈时间: {{ info.productionFeedbackTime }}</td>
                        </tr>
                        <!-- <tr>
                    ...
                    <td colspan="6" class="b">反馈确认人: {{info.feedbackTimeConfirmUser}}</td>
                        ...
                        <tr>
                            <td colspan="17" class="b">订单产品列表</td>
                        </tr>
                        <tr>
                        ...
                        <tr v-if="accessoryList.length > 0">
                            <td colspan="17" class="b">审批附件:</td>
                        </tr>
                        <tr v-if="accessoryList.length > 0">
                            <td colspan="6" class="b">文件名称</td>
                            <td colspan="7" class="b">文件地址</td>
