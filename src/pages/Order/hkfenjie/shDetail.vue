<template>
    <div class="page-orders-list">
        ...
        <div class="flex-item scroll-y">
            <data-list ref="list" :param="filter" url="/haolifa/finance/billContract/selectBizBillChildList" method="post">
                <tr slot="header">
                ...
                <template slot="item" slot-scope="{ item, index }">
                    ...
                    <td class="t-right">
                        <a href="javascript:;" v-if="item.canAudit" class="blue" @click="edit(item)" style="margin-right: 3px;">审核 |</a>
                        <a href="javascript:;" class="blue" @click="detail(item)" style="margin-right: 3px;">详情</a>
                    </td>
                </template>
            </data-list>
        </div>
        <layer v-if="addLayer" title="审核" width="30%">
            <div class="layer-text" style="padding-bottom: 50px;">
                <div class="flex">
                    <select-box v-model="form.auditStatus" class="flex-item mr-20" hint="必填" :list="auditStatusList" label="审核状态"></select-box>
                </div>
                <div class="flex">
            ...
            <div class="layer-btns">
                ...
                <el-button class="mr-20" size="mini" @click="addLayer=false">关闭</el-button>
            </div>
        </layer>
        <layer v-if="layer" title="详情" width="80%">
            ...
            <div class="layer-btns">
                <btn flat color="#008eff" @click="layer = false;accessoryList = [];">关闭</btn>
            </div>
        </layer>
    </div>
</template>
