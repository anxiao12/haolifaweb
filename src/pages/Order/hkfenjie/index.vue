    ...
    <div class="page-orders-list">
        ...
        <div class="flex-v-center tool-bar">
            <div class="flex-v-center search-bar" style="margin-right: 20px">
                ...
                <input type="text" class="flex-item" v-model="filter.certificateNumber" @change="$refs.list.update(true)"
                    placeholder="凭证号" style="width: 200px" />
                <input type="text" class="flex-item" v-model="filter.collectCompany" @change="$refs.list.update(true)"
                    placeholder="收款单位" style="width: 200px" />
                <input type="text" class="flex-item" v-model="filter.payCompany" @change="$refs.list.update(true)"
                    placeholder="付款单位" style="width: 200px" />
                分解状态：
                <select v-model="filter.contractStatus" class="f-14" @change="$refs.list.update(true)">
        ...
        <div class="flex-item scroll-y">
            <data-list ref="list" :param="filter" url="/haolifa/finance/billContract/billList" method="post">
                <tr slot="header">
                ...
                <template slot="item" slot-scope="{ item, index }">
                    ...
                    <td class="t-right">
                        <router-link :to="'/fenjieList?id=' + item.id + '&billType=' + item.billType">
                            <btn class="b" flat color="#008eff">回款分解</btn>
                        </router-link>
                    </td>
                </template>
            </data-list>
