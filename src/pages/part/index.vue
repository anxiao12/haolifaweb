        ...
        <layer v-if="layer" title="出库" width="70%">
            <div style="padding:0 30px;">
                ...
                <div class="flex-v-center">
                    ...
                    <el-select v-model="materialBatchNo" style="width: 75%;" class="mr-10" placeholder="批次号" :multiple="true">
                        <el-option v-for="item in materialBatchNoList" :key="item.value" :label="item.text" :value="item.value"></el-option>
                    </el-select>
