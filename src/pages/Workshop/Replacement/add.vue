<template>
    <div class="page-room-add abs scroll-y">
        <div class="form-content">
            ...
            <div class="flex-v-center">
                <input-box v-model="form.materialCount" class="mr-10" label="零件数量" hint="必填，请输入数字" style="width: 50%"
            ...
            <div class="flex-v-center">
                ...
                <select-box v-model="form.unqualifiedType" class="flex-item mr-10" hint="必填" :list="unqualifiedTypeList"
                    label="不合格类型"></select-box>

            </div>
            <div class="flex-v-center">
                <input-box v-model="form.replaceReason" hint="必填" class="flex-item mr-10" multi-line
                    label="更换原因"></input-box>
            </div>
...
export default {
    ...
    methods: {
        ...
        cancel() {
            let url = this.form.id ? "/replacementedit" : "/replacementadd";
            this.$confirm({
                title: "您确定要离开此页面吗？",
                text: "您的表单将不会保存",
                color: "red",
                ...
                yes: () => {
                    ...
                    this.$router.push("/replacement/addList");
                }
            });
        },
        submit() {
