...
export default {
    ...
    methods: {
        ...
        updateStatus(item, status) {
            ...
            this.$confirm({
                ...
                yes: () => {
                    this.$http
                        .get(
                            `/haolifa/entrust/updateStatus/${item.entrustNo}/${status}`
                        )
                        .then(res => {
                            this.$toast("状态变更成功");
                            this.$refs.list.update(true);
        ...
        download() {
            ...
            a.setAttribute(
                "href",
                `/haolifa/export/material-entry?type=2&startDate=${this.form.startDate}&endDate=${this.form.endDate}&entryStatus=${this.form.entryStatus}`
            );
            a.click();
