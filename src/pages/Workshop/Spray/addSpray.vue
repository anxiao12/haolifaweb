        ...
        <div class="content">
            ...
            >
                <div class="flex-item">
                    ...
                    <div class="flex">
                        <select-box
                            :list="item.sprayColorList"
                            @change="createTuhao(i)"
                            v-model="item.relationNo"
                            class="flex-item mr-10"
                            label="喷涂颜色"
                        ></select-box>
                        <input-box
