            ...
            <div class="card flex" style="margin-top: 0;" v-for="(item, i) in form.items" :key="i">
                <div class="flex-item">
                    <div class="flex">
                        ...
                        <el-select class="flex-item mr-10 mycs" v-model="item.materialGraphNo" filterable @change="getBatchNumber(i,item.materialGraphNo)" placeholder="零件图号请选择">
                            <el-option v-for="(obj,j) in item.tuhaoList" :key="j" :label="obj.text" :value="obj.value"></el-option>
                        </el-select>
