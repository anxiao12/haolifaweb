            ...
            >
                ...
                >
                    ...
                    <td>
                        <a
                            class="fixed-length"
                            :href="item.orderContractExtendUrl"
                            :title="item.orderContractExtendUrl"
                        >{{item.orderContractExtendUrl}}</a>
                    </td>
            ...
            >
                <div class="form-content metalwork-info">
                    ...
                    <td colspan="6" class="b">反馈确认人: {{info.feedbackTimeConfirmUser}}</td>
                        ...
                        <tr
                            v-for="(val,i) in JSON.parse(info.technicalRequire)"
                            :key="i"
                        >
                        ...
                        <tr
                            v-for="(item,i) in info.orderProductAssociates"
                            :key="i"
                        >
                        ...
                        <tr
                            v-for="(accessory,i) in accessoryList"
                            :key="i"
                        >
