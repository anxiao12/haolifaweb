<template>
  <div class="page-invoice-list">
    ...
    <div class="flex-v-center tool-bar">
      ...
      <btn class="b" flat color="#008eff" @click="add" v-has="'wtdn-scjs-add'"
        >新增</btn
      >
    </div>
    <div class="flex-v-center tool-bar">
    ...
    <div class="flex-item scroll-y">
      <data-list
        ...
        :page-size="15"
        :param="filter"
        url="/haolifa/problemRecordTechnology/page"
        method="post"
      >
        <tr slot="header">
  ...
  methods: {
    ...
    remove(item) {
      this.$confirm({
        ...
        yes: () => {
          this.$http
            .post(`/haolifa/problemRecordTechnology/del/${item.id}`, {
              id: item.id,
            })
            .then((res) => {
              this.$toast('删除成功');
