<template>
    <div class="page-role flex-col">
        <div class="flex-v-center tool-bar">
            ...
            <btn class="b" flat color="#008eff" @click="$store.commit('DELMENUTABS', '/role/tree');$router.back()">返回</btn>
        </div>
        <div class="flex-item scroll-y">
            <el-tree ref="tree" :data="data" node-key="id" :props="defaultProps"></el-tree>
        </div>
