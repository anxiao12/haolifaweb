        ...
        <div class="flex-v-center tool-bar">
            ...
            <div class="flex-v-center search-bar" style="margin-right: 20px;">
                ...
                <el-date-picker v-model="filter.startDate" type="date" value-format="yyyy-MM-dd"
                    @change="$refs.list.update(true); getPriceTotal()" :editable="false" placeholder="选择年月日"
                    style="width: 180px;"></el-date-picker>结束时间:
                ...
                <input type="text" class="flex-item" v-model="filter.orderNo"
                    @change="$refs.list.update(true); getPriceTotal()" placeholder="采购合同号" style="width: 200px;">
                <i class="icon f-20 c-8">search</i>
                <input type="text" class="flex-item" v-model="filter.supplierName"
                    @change="$refs.list.update(true); getPriceTotal()" placeholder="供应商" style="width: 200px;">
