        ...
        <div class="flex-item scroll-y">
            <data-list ref="list" :param="filter" url="/haolifa/delivery/noticeList" method="post">
                ...
                <template slot="item" slot-scope="{ item, index }">
                    ...
                    <td>
                        <a target="_blank" class="fixed-length" v-if="(item.deliveryUrl).match('\.(pdf|jpe?g|png|bmp)$') " :href="item.deliveryUrl">预览</a>
                        <a target="_blank" v-if="!(item.deliveryUrl).match('\.(pdf|jpe?g|png|bmp)$')" :href="'http://view.officeapps.live.com/op/view.aspx?src='+ item.deliveryUrl">预览</a>
