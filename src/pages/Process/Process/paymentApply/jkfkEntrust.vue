                            ...
                            <div class="layer-text" style="padding:0;">
                                <div class="form-content metalwork-info">
                                    <table class="f-14 order-info">
                                        ...
                                        <tr>
                                            <td colspan="2" class="b">借款人 :</td>
                                            <td colspan="3">{{info.loanUserName}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="b">借款金额 :</td>
                                            <td colspan="3">{{info.amount}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="b">部门 :</td>
                                            <td colspan="3">{{info.deptName}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="b">资金性质 :</td>
                                            <td colspan="3">{{info.amountTypeCN}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="b">户名 :</td>
                                            <td colspan="3">{{info.accountName}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="b">开户行 :</td>
                                            <td colspan="3">{{info.bankOfDeposit}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="b">卡号 :</td>
                                            <td colspan="3">{{info.cardNumber}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="b">借款日期 :</td>
                                            <td colspan="3">{{info.loanDate}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="b">预计还款日期 :</td>
                                            <td colspan="3">{{info.expectRepaymentDate}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="b">用途 :</td>
                                            <td colspan="3">{{info.purpose}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="b">备注摘要 :</td>
        ...
        getData() {
            this.$http
                ...
                .then(res => {
                    ...
                    this.$http
                        .get(`/haolifa/finance/loanapply/info/${res.formId}`)
                        .then(result => {
                            this.info = result;
