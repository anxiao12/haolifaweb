            ...
            <div class="node">
                ...
                <div class="node-title mb-10">
                    ...
                    <router-link class="c-4" :to="'/process/supplier/'+data.formId">
                        <span class="mr-15">
                            {{data.formNo}}
                            <a href="javascript:;" class="blue">查看</a>
                        </span>
                    </router-link>
                </div>
                <div class="node-title mb-10">
            ...
            <div v-if="data.dealStep">
                ...
                <div class="node">
                    <div>
                        ...
                        <div class="flex">
                            <upload-box btnText="附件上传" :multiple="multiple" :fileList="fileList" :onchange="uploadFile" :onremove="removeFile" style="width: 50%"></upload-box>
                        </div>
