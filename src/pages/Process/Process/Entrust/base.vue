            ...
            <div class="node">
                ...
                <div class="node-title mb-10">
                    ...
                    <span>
                        ...
                        <a target="_blank" flat style="color: #008eff" v-if="!(orderUrl).match('\.(pdf|jpe?g|png|bmp)$')" :href="'http://view.officeapps.live.com/op/view.aspx?src='+ orderUrl">预览</a>
                        <!--<span>-->
                        <!--<a class="a" target="_blank" flat style="color: #008eff" :href="orderUrl">下载机加工订单</a>-->
                    </span>
                </div>
...
export default {
    ...
    data() {
        return {
            data: null,
            orderUrl: "/haolifa/export/entrustOrder/",
            backStepLayer: false,
            auditResults: [
                { status: 0, name: "审核不通过" },
                { status: 1, name: "审核通过" },
