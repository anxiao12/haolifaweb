        ...
        <div class="content">
            ...
            <div class="flex">
               ...
               <date-picker v-model="form.confirmTime" class="flex-item mr-10" label="确认时间" style="margin-right: 20px;"></date-picker>
                <!-- <date-picker v-model="form.deliveryTime" class="flex-item mr-10" label="交货时间" style="margin-right: 20px;"></date-picker> -->
            </div>
            ...
            <div class="card flex" style="margin-top: 0;" v-for="(item, i) in form.itemList" :key="i">
                <div class="flex-item">
                    <div class="flex">
                        ...
                        <input-box v-model="item.productName" type="number" class="flex-item mr-10" label="产品名称"></input-box>
                        <input-box v-model="item.productModel" type="number" class="flex-item mr-10" label="型号"></input-box>
                    ...
                    <div class="flex">
                        ...
                        <input-box v-model="item.valveBodyMaterial" type="number" class="flex-item mr-10" label="阀体"></input-box>
                    </div>
                    <div class="flex">
                        ...
                        <input-box v-model="item.driveForm" type="number" class="flex-item mr-10" label="驱动形式"></input-box>
                        <input-box v-model="item.connectionMethod" type="number" class="flex-item mr-10" label="链接方式"></input-box>
                    </div>
                    <div class="flex">
                        <input-box v-model="item.valveShaft" class="flex-item mr-10" label="阀轴材质"></input-box>
                        <input-box v-model="item.itemAmount" class="flex-item mr-10" label="分项金额"></input-box>
    ...
    methods: {
      cancel(){
        ...
        submit() {
            ...
            //     productNumber:'数量',
            //     unitPrice:'采购价',
            //     valveBodyMaterial:'阀体',
            //     valveCoreMaterial:'阀芯',
            //     sealingMaterial:'密封材质',
            //     driveForm:'驱动形式',
            //     connectionMethod:'链接方式',
            //     valveShaft:'阀轴材质',
            //     // remark:'备注',
            // };
            // let flag = true;
